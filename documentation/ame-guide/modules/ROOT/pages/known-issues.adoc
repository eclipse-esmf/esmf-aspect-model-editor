...
h| Workaround
a|
Check that you have not missed parts of the TTL file. Also check against syntax errors consulting https://eclipse-esmf.github.io/samm-specification/2.0.0/namespaces.html[Namespaces and versions (SAMM 2.0.0)^,opts=nofollow].
|===
...
https://eclipse-esmf.github.io/samm-specification/2.0.0/datatypes.html[Datatypes (SAMM 2.0.0)^,opts=nofollow]
...
[[import-export-problems-win]]
=== Import/Export problems with Windows

[%noheader,cols="15%,85%"]
|===
h| Error
a|
From time to time Windows may block some files during import or export and errors may occur.
...
Restarting the Aspect Model Editor can solve the problem. Please save all files first.
|===
