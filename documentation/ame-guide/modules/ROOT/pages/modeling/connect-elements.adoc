...
The larger the diagram, the harder it might get to connect elements that are far away in the model. In that case, you can also use the alternative decribed bellow.
