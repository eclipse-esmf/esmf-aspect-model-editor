...
The larger the diagram, the harder it might get to select elements that are fare away.
...
* The new pop-up displays all the elements of the model. +
  In case there are too many elements, type the name in the search field.
