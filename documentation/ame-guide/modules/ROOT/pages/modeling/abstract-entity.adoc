...
. Create one Property by clicking twice on the Aspect's Add icon image:add.png[Add icon, 2%].
. Create one Characteristic by clicking the Add icon image:add.png[Add icon, 2%].
. Create one Entity by clicking the bottom Add icon image:add.png[Add icon, 2%].
