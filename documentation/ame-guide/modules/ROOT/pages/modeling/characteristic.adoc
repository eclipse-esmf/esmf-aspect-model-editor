...
For the correct understanding of Characteristics, see https://eclipse-esmf.github.io/samm-specification/2.2.0/characteristics.html[Characteristics and Constraints (SAMM 2.2.0)^,opts=nofollow].
...
`xsd:integer` or `xsd:string` (no quotation marks, no spaces), see https://eclipse-esmf.github.io/samm-specification/2.2.0/datatypes.html[Data Types (SAMM 2.2.0)^,opts=nofollow].
+
...
See also https://eclipse-esmf.github.io/samm-specification/2.2.0/modeling-guidelines.html#declaring-enumerations[Declaring Enumerations(SAMM 2.2.0)^,opts=nofollow].
...
For more background on Structured Values, see https://eclipse-esmf.github.io/samm-specification/2.2.0/characteristics.html#structured-value-characteristic[Structured Value(SAMM 2.2.0)^,opts=nofollow]
...
If your Characteristic is a *Quantifiable* (see https://eclipse-esmf.github.io/samm-specification/2.2.0/characteristics.html[Characteristics (SAMM 2.2.0)^,opts=nofollow]), Unit is an optional attribute (only exception for not having a Unit: unit-less countable Quantifiable).
...
For a complete list of supported Units refer to the https://eclipse-esmf.github.io/samm-specification/2.2.0/appendix/unitcatalog.html[Unit Catalog (SAMM 2.2.0)^,opts=nofollow].

Further explanations about using Units can be found in https://eclipse-esmf.github.io/samm-specification/2.2.0/characteristics.html[Characteristics (SAMM 2.2.0)^,opts=nofollow].
