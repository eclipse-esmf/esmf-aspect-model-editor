...
For an overview of Aspect Model elements, see https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/meta-model-elements.html[Meta Model Elements (SAMM 2.0.0)^,opts=nofollow].
...
For more information, see https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/modeling-guidelines.html#naming-rules[Naming rules (SAMM 2.0.0)^,opts=nofollow].
...
For more information, see https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/modeling-guidelines.html#adding-external-references[Adding external references (SAMM 2.0.0)^,opts=nofollow].
...
See https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/modeling-guidelines.html#optional-properties[Optional Properties (SAMM 2.0.0)^,opts=nofollow].
...
For the correct understanding of Characteristics, see https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/characteristics.html[Characteristics and Constraints (SAMM 2.0.0)^,opts=nofollow].
...
`xsd:integer` or `xsd:string` (no quotation marks, no spaces), see https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/datatypes.html[Data Types (SAMM 2.0.0)^,opts=nofollow].
+
...
See also https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/modeling-guidelines.html#declaring-enumerations[Declaring Enumerations(SAMM 2.0.0)^,opts=nofollow].
...
For more background on Structured Values, see https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/characteristics.html#structured-value-characteristic[Structured Value(SAMM 2.0.0)^,opts=nofollow]
...
If your Characteristic is a *Quantifiable* (see https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/characteristics.html[Characteristics (SAMM 2.0.0)^,opts=nofollow]), Unit is an optional attribute (only exception for not having a Unit: unit-less countable Quantifiable).
...
For a complete list of supported Units refer to the https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/appendix/unitcatalog.html[Unit Catalog (SAMM 2.0.0)^,opts=nofollow].

Further explanations about using Units can be found in https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/characteristics.html[Characteristics (SAMM 2.0.0)^,opts=nofollow].
...
A list of the available Constraints can be found in the https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/characteristics.html[SAMM Aspect Meta Model version 1.0.0.^,opts=nofollow].
