...
1. xref:namespace/import-package.adoc#import-package[Import the namespace] you want to use.
...
[NOTE]
====
When you drag and drop an reference, it will also include all the lower connections (dependencies) of the element. Same goes for deleting the element &ndash; all dependencies will be deleted as well.
