...
. Download the executable installation file from the https://github.com/bci-oss/rbs-aspect-model-editor/releases[Aspect Model Editor^, opts=nofollow] releases.
