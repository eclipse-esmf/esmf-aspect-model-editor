...
* Check that your system meets the xref:system-requirements.adoc[system requirements].
...
See the xref:release-notes.adoc[release notes] to find out what changed in the version you want to upgrade to.
