...
For more information, see https://openmanufacturingplatform.github.io/sds-bamm-aspect-meta-model/bamm-specification/2.0.0/namespaces.html[Namespaces (SAMM 2.0.0)^,opts=nofollow].
