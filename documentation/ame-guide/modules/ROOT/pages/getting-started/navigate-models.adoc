...
To toggle the map's visibility, click the *Toggle minimap* icon image:../../../../../core/apps/ame/src/assets/img/png/app-menu/enabled/map_FILL0_wght400_GRAD0_opsz24.png[Map toggle icon] in the xref:getting-started/ui-overview.adoc#menu-view[menu view].
...
To toggle the navigation's visibility which are in the toolbar, click the *Toggle Toolbar* icon image:../../../../../core/apps/ame/src/assets/img/png/app-menu/enabled/build_FILL0_wght400_GRAD0_opsz24.png[Navigation toggle icon] in the xref:getting-started/ui-overview.adoc#menu-view[menu view].

The navigation provides the following options:

* Zoom in image:../../../../../core/apps/ame/src/assets/img/png/app-menu/enabled/zoom_in_FILL0_wght400_GRAD0_opsz24.png[Zoom in icons]
* Zoom out image:../../../../../core/apps/ame/src/assets/img/png/app-menu/enabled/zoom_out_FILL0_wght400_GRAD0_opsz24.png[Zoom out icons]
