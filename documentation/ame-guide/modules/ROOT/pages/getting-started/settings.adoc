...
image::settings-automated-workflow.png[Automated Workflow menu in Settings dialog,width=100%]
...
image::settings-editor.png[Editor menu in Settings dialog,width=100%]
...
image::settings-languages.png[Languages menu in Settings dialog,width=100%]
...
image::settings-namespaces.png[Languages menu in Settings dialog,width=100%]
