...
image::settings-automated-workflow.png[Automated Workflow menu in Settings dialog,width=50%]
...
image::settings-editor.png[Editor menu in Settings dialog,width=50%]
...
image::settings-languages.png[Languages menu in Settings dialog,width=50%]
...
image::settings-namespaces.png[Languages menu in Settings dialog,width=50%]
...
image::settings-copyright-header.png[Copyright/Header menu in Settings dialog,width=50%]
