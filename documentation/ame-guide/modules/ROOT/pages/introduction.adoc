...
[NOTE]
====
 Beside this latest version, the documentation of the most recent older versions is also available here (and we do recommend frequent updates).
 You can access the older versions from the dropdown top right on this page.

image:versions-dropdown.png[Versions dropdown,width=40%]
====
