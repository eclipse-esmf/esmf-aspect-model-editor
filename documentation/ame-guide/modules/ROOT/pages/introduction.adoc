...
This program and the accompanying materials are made under the terms of https://github.com/bci-oss/rbs-aspect-model-editor/blob/master/LICENSE[Mozilla Public License, V. 2.0^, opts=nofollow].

All contained third-party materials are listed in the https://github.com/bci-oss/rbs-aspect-model-editor/blob/master/NOTICE.md[NOTICE.md^, opts=nofollow] file.
