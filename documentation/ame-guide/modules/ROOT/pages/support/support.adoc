...
Also make sure your system meets the xref:system-requirements.adoc[system requirements].
...
* For Linux users: Press Ctrl+Shift+I on your keyboard to open the developer tools.
