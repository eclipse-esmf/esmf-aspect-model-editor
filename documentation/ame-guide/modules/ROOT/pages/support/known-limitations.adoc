...
To run the application, users need to either:
...
* Or allow the app manually via *System Settings* -> *Privacy & Security*, by scrolling down to the security section after the first blocked launch attempt and clicking *Open Anyway*.
|===
