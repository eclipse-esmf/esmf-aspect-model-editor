...
export const simpleDataTypes = {
  ...
  base64Binary: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#base64Binary', description: 'Base64-encoded binary data'},
  ...
  date: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#date', description: 'Dates (yyyy-mm-dd) with or without timezone'},
  dateTime: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#dateTime', description: 'Date and time with or without timezone'},
  decimal: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#decimal', description: 'Arbitrary-precision decimal numbers'},
  dateTimeStamp: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#dateTimeStamp', description: 'Date and time with required timezone'},
  dayTimeDuration: {
    isDefinedBy: 'http://www.w3.org/2001/XMLSchema#dayTimeDuration',
    description: 'Duration of time (days, hours, minutes, seconds only)',
  },
  double: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#double', description: '64-bit floating point numbers incl. ±Inf, ±0, NaN'},
  duration: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#duration', description: 'Duration of time'},
  float: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#float', description: '32-bit floating point numbers incl. ±Inf, ±0, NaN'},
  ...
  gMonthDay: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#gMonthDay', description: 'Gregorian calendar month and day'},
  gYearMonth: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#gYearMonth', description: 'Gregorian calendar year and month'},
  ...
  long: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#long', description: '-9223372036854775808…+9223372036854775807 (64 bit)'},
  negativeInteger: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#negativeInteger', description: 'Integer numbers <0'},
  nonPositiveInteger: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#nonPositiveInteger', description: 'Integer numbers ≥0'},
  nonNegativeInteger: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#nonNegativeInteger', description: 'Integer numbers ≤0'},
  ...
  time: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#time', description: 'Times (hh:mm:ss.sss…) with or without timezone'},
  ...
  unsignedLong: {isDefinedBy: 'http://www.w3.org/2001/XMLSchema#unsignedLong', description: '0…18446744073709551615 (64 bit)'},
