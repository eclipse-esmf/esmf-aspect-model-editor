...
describe('OperationComponent', () => {
  ...
  it('should aggregate Operation fields in the native Signal Form context', () => {
    expect(component.signalForm().value()).toMatchObject({inputChipList: [], output: '', outputValue: null});
  });
});
