...
@Component({
  ...
  template: `<button mat-button mat-icon-button matTooltip="Locate element" matTooltipPosition="above" *ngIf="element" (click)="locate()">
...
export class LocateElementComponent {
  ...
  constructor(public metaModelDialogService: EditorModelService, private mxgraphService: MxGraphService) {
    this.metaModelDialogService.getMetaModelElement().subscribe(element => (this.element = element));
  }
