...
export class SymbolInputFieldComponent extends InputFieldComponent<DefaultUnit> implements OnInit, OnDestroy {
  ...
  initSymbolControl() {
    this.model.set(this.metaModelElement?.symbol || '');
    this.unregisterField = this.signalForm().register('symbol', this.field);
  }
