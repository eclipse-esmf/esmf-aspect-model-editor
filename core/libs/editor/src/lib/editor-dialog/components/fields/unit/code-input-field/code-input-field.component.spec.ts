...
describe('CodeInputFieldComponent', () => {
  let component: CodeInputFieldComponent;
  let fixture: ComponentFixture<CodeInputFieldComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [CodeInputFieldComponent, BrowserAnimationsModule],
      providers: [
    ...
    fixture = TestBed.createComponent(CodeInputFieldComponent);
    component = fixture.componentInstance;
    fixture.componentRef.setInput('signalForm', signalForm);
    fixture.detectChanges();
  });

  it('should initialize and register code in signalForm', () => {
    expect(component).toBeTruthy();
    expect(signalForm.value().code).toBe('MTR');
    expect(component.field().valid()).toBe(true);
  });

  it('should unregister code field on destroy', () => {
    fixture.destroy();
    expect(signalForm.value()).not.toHaveProperty('code');
  });
});
