        ...
        'org.eclipse.examples.aspect': [
          {
            ...
            models: [
              {
                model: fileName,
                aspectModelUrn: 'urn:samm:org.eclipse.examples.aspect:1.0.0#externalProperty',
    ...
    cy.intercept(
      {
        ...
        headers: {'Aspect-Model-Urn': 'urn:samm:org.eclipse.examples.aspect:1.0.0#externalProperty'},
      },
      {
