...
import {ModelInfo, MxGraphAttributeService, MxGraphHelper, MxGraphService, MxGraphShapeOverlayService} from '@bame/mx-graph';
import {
  Aspect,
  Base,
...
import {ExpandedModelShape, NotificationsService} from '@bame/shared';
