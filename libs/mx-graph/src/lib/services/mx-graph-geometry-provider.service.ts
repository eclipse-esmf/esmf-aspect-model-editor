...
import {BaseMetaModelElement, DefaultTrait, DefaultEntityValue} from '@bame/meta-model';
import {ExpandedEllipseShape, ExpandedRoundBorderShape, ExpandedModelShape} from '@bame/shared';
