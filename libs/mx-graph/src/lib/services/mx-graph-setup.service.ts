...
import {DefaultEntity, DefaultEntityValue, DefaultTrait} from '@bame/meta-model';
import {ConfigurationService} from '@bame/settings-dialog';
import {AppConfig, AssetsPath, BindingsService, BrowserService} from '@bame/shared';
...
export class MxGraphSetupService {
  ...
  constructor(
    @Inject(CORE_CONFIG) private appConfig: AppConfig,
