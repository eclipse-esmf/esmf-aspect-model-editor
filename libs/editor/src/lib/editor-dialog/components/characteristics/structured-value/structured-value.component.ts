...
import {DefaultStructuredValue, OverWrittenProperty} from '@bame/meta-model';
...
export class StructuredValueComponent extends InputFieldComponent<DefaultStructuredValue> implements OnInit, OnDestroy {
  ...
  openModal() {
    this.modalWindowService
      .openDialogWithComponent(StructuredValuePropertiesComponent, {
