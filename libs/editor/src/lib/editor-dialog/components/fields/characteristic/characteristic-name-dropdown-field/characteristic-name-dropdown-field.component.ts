...
import {BammCharacteristicInstantiator, BammUnitInstantiator, MetaModelElementInstantiator} from '@bame/instantiator';
import {
...
@Component({
  selector: 'bci-characteristic-name-dropdown-field',
