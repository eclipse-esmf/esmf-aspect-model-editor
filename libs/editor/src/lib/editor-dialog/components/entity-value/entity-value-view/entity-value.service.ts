...
import {DefaultProperty, OverWrittenProperty, DefaultEntity, DefaultEnumeration, DefaultEntityValue} from '@bame/meta-model';
import {ConfirmDialogService} from '@bame/editor';
