...
describe('Test drag and drop', () => {
  ...
  it('Loading operation element with there children from external file with different namespace', () => {
    cy.intercept('POST', 'http://localhost:9091/bame/api/models/validate', {fixture: 'model-validation-response.json'});
    cy.intercept('GET', 'http://localhost:9091/bame/api/models/namespaces', {
      'com.bosch.nexeed.different:1.0.0': ['external-operation-reference-with-children.txt'],
    });
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://localhost:9091/bame/api/models',
        headers: {'Bame-Model-Urn': 'com.bosch.nexeed.different:1.0.0:external-operation-reference-with-children.txt'},
      },
      {
  ...
  it('Loading unit element from external file with different namespace', () => {
    cy.intercept('POST', 'http://localhost:9091/bame/api/models/validate', {fixture: 'model-validation-response.json'});
    cy.intercept('GET', 'http://localhost:9091/bame/api/models/namespaces', {
      'com.bosch.nexeed.different:1.0.0': ['external-unit-reference.txt'],
    });
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://localhost:9091/bame/api/models',
        headers: {'Bame-Model-Urn': 'com.bosch.nexeed.different:1.0.0:external-unit-reference.txt'},
      },
      {
  ...
  it('Loading different elements from several external files with different namespace', () => {
    ...
    cy.intercept(
      {
        method: 'GET',
        url: 'http://localhost:9091/bame/api/models',
        headers: {'Bame-Model-Urn': 'com.bosch.nexeed.different:1.0.0:external-trait-reference.txt'},
      },
      {
    ...
    cy.fixture('/external-reference/different-namespace/model-with-several-external-reference')
      ...
      .then(rdf => {
        ...
        expect(rdf).to.contain('@prefix different: <urn:bamm:com.bosch.nexeed.different:1.0.0#>.');
