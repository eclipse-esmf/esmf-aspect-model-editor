...
describe('Test edit operation', () => {
  ...
  it('can edit name', () => {
    cy.shapeExists('operation1')
      ...
      .then(() => cy.get(FIELD_name).clear().type('newOperation'))
  ...
  it('can add input and output property in edit view', () => {
    cy.shapeExists('newOperation')
      ...
      .then(() =>
        cy.get(FIELD_inputValues).clear().type('addInputProperty1').get('mat-option').contains('addInputProperty1').click({force: true})
      )
      .then(() =>
        cy.get(FIELD_inputValues).clear().type('addInputProperty2').get('mat-option').contains('addInputProperty2').click({force: true})
      )
      .then(() =>
        cy.get(FIELD_output).clear().type('addOutputProperty1').get('mat-option').contains('addOutputProperty1').click({force: true})
      )
      .then(() => cy.get(SELECTOR_editorSaveButton).focus().click({force: true}))
      .then(() =>
        cy.getAspect().then((aspect: Aspect) => {
  ...
  it('can delete output in edit view', () => {
    cy.shapeExists('newOperation')
      ...
      .then(() =>
        cy.get(FIELD_output).clear().type('addNewOutputProperty1').get('mat-option').contains('addNewOutputProperty1').click({force: true})
      )
      .then(() => cy.get(SELECTOR_editorSaveButton).focus().click({force: true}))
      .then(() =>
        cy.getAspect().then((aspect: Aspect) => {
    ...
    cy.shapeExists('newOperation')
      ...
      .then(() =>
        cy
          ...
          .clear()
          .type('addNewOutputProperty1')
          .get('mat-option')
          .contains('addNewOutputProperty1')
          .click({force: true})
      )
      .then(() =>
        cy.get(FIELD_output).clear().type('addNewOutputProperty2').get('mat-option').contains('addNewOutputProperty2').click({force: true})
      )
      .then(() => cy.get(SELECTOR_editorSaveButton).focus().click({force: true}))
      .then(() =>
        cy.getAspect().then((aspect: Aspect) => {
