...
describe('Test enumeration entity value', () => {
  it('should create nested entity values', () => {
    ...
    cy.startModelling()
      ...
      .then(() => cy.get(FIELD_dataType).clear().type('NewEntity').get('.mat-option-text').contains('NewEntity').click({force: true}))
      ...
      .then(() =>
        cy
          ...
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').type('ev1'))
          .then(() =>
            cy
  ...
  it('should rename nested entity values', () => {
    cy.dbClickShape('ev1')
      ...
      .wait(1000)
      .then(() => dbClickEntityValue('ev2'))
      .then(() => cy.get(FIELD_name).should('be.visible').click({force: true}).clear().type('ev2edit'))
      .then(() => cy.get(SELECTOR_editorSaveButton).click({force: true}))
      .wait(1000)
      .then(() => dbClickEntityValue('ev3'))
      .then(() => cy.get(FIELD_name).should('be.visible').click({force: true}).clear().type('ev3edit'))
      .then(() => cy.get(SELECTOR_editorSaveButton).click({force: true}))
      .wait(1000)
      .then(() => {
  ...
  it('should add properties and set values', () => {
    cy.clickAddShapePlusIcon('Entity1')
      ...
      .wait(1000)
      .then(() => dbClickEntityValue('ev2edit'))
      .wait(1000)
      .then(() => {
        cy.get(FIELD_propertyValueNotComplex).eq(0).should('be.visible').type('ev2Value');
        cy.get(SELECTOR_editorSaveButton).click({force: true});
      })
      .wait(1000)
      .then(() => dbClickEntityValue('ev3edit'))
      .wait(1000)
      .then(() => {
        cy.get(FIELD_propertyValueNotComplex).eq(0).should('be.visible').type('ev3Value');
        cy.get(SELECTOR_editorSaveButton).click({force: true});
      })
      .wait(1000)
      .then(() =>
    ...
    cy.startModelling()
      ...
      .then(() => {
        cy.get(FIELD_characteristicName)
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').type('EntityValue1'))
          .then(() => cy.get(FIELD_propertyValueNotComplex).should('be.visible').type('TestPropertyValue1'))
          .then(() => cy.get(SELECTOR_entitySaveButton).click({force: true}))
          .wait(1000)
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').type('EntityValue2'))
          .then(() => cy.get(FIELD_propertyValueNotComplex).should('be.visible').type('TestPropertyValue2'))
          .then(() => cy.get(SELECTOR_entitySaveButton).click({force: true}))
          .wait(1000)
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').type('EntityValue3'))
          .then(() => cy.get(FIELD_propertyValueNotComplex).should('be.visible').type('TestPropertyValue3'))
          .then(() => cy.get(SELECTOR_entitySaveButton).click({force: true}))
          .wait(1000)
    ...
    cy.startModelling()
      ...
      .then(() => {
        cy.get(FIELD_characteristicName)
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').type('EntityValue'))
    ...
    cy.startModelling()
      ...
      .then(() => {
        cy.get(FIELD_characteristicName)
          ...
          .contains('Enumeration')
          .click({force: true})
          .then(() => cy.get(SELECTOR_searchEntityValueInputField).should('be.visible'));
      })
      .then(() =>
        cy
          .get(SELECTOR_addEntityValue)
          .click({force: true})
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').type('EntityValue'))
          .then(() => cy.get(SELECTOR_entitySaveButton).click({force: true}))
  ...
  it('import new model with entity values', () => {
    ...
    cy.fixture('entity-values-enumeration')
      ...
      .then(() => cy.get(SELECTOR_dialogStartButton).click({force: true}).wait(4000))
      .then(() => cy.get('.toggle-sidebar').click({force: true}))
      .then(() => cy.dbClickShape('Characteristic1'))
      .then(() => {
  ...
  it('search for entity value', () => {
    cy.shapeExists('Characteristic1')
      ...
      .type('test2')
      .then(() => {
        cy.get('mat-cell').should(cells => expect(cells).to.have.lengthOf(4));
  ...
  it('edit all entity values', () => {
    cy.shapeExists('test1')
      .then(() => dbClickEntityValue('test1'))
      .then(() => cy.wait(200))

      // BEGIN: forcing to double click again and close then reopen because weird error
      .then(() => dbClickEntityValue('test1'))
      .then(() => cy.wait(200))
      ...
      .then(() => cy.get(FIELD_name).clear().type('edit1'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(0).clear().type('property2Edit1'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(1).clear().type('property3Edit1'))
      .then(() => cy.get(SELECTOR_editorSaveButton).click({force: true}))
      .wait(1000)
      .shapeExists('test2')
      .then(() => dbClickEntityValue('test2'))
      .then(() => cy.get(FIELD_name).clear().type('edit2'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(0).clear().type('property2Edit2'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(1).clear().type('property3Edit2'))
      .then(() => cy.get(SELECTOR_editorSaveButton).click({force: true}))
      .wait(1000)
      .shapeExists('test3')
      .then(() => dbClickEntityValue('test3'))
      .then(() => cy.get(FIELD_name).clear().type('edit3'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(0).clear().type('property2Edit3'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(1).clear().type('property3Edit3'))
      .then(() => cy.get(SELECTOR_editorSaveButton).click({force: true}))
      .wait(1000)
  ...
  it('edit one entity values', () => {
    cy.shapeExists('edit2')
      .then(() => dbClickEntityValue('edit2'))
      .then(() => cy.get(FIELD_name).should('be.visible').clear().type('editOnlyOnEntityValue'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(0).should('be.visible').clear().type('editOnlyOnEntityValueProp2'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(1).should('be.visible').clear().type('editOnlyOnEntityValueProp3'))
      .then(() => cy.get(SELECTOR_editorSaveButton).click({force: true}))
      .wait(1000)
      .shapeExists('Characteristic1')
  ...
  it('can not remove mandatory value', () => {
    cy.shapeExists('edit1')
      .then(() => dbClickEntityValue('edit1'))
      .then(() => cy.get(FIELD_propertyValueNotComplex).eq(0).should('be.visible').clear())
      .then(() =>
        cy
  ...
  it('make property optional then remove its value', () => {
    cy.shapeExists('Entity1')
      ...
      .wait(1000)
      .then(() => {
        cy.get(`input[type="checkbox"][name="property2_${FIELD_optional}"]`).click({force: true});
        return cy.wait(1000);
      })
  ...
  it('delete all entity value one by one', () => {
    ...
    cy.fixture('entity-values-enumeration')
      ...
      .then(() => {
        cy.get('mat-cell').should(cells => expect(cells).to.have.lengthOf(8));
      })
      .then(() => {
        checkMatPanelTitleValues([0], ['test2']);
        checkMatCellValues([0, 1, 2, 3], ['property2', 'test2p2', 'property3', 'test2p3']);
  ...
  it('check add new entityValue overlay in place after adding multiple entityValues for one enumeration', () => {
    cy.clickShape('Characteristic1').then(() =>
      cyHelp
        .hasAddShapeOverlay('Characteristic1')
        .then(() => cy.clickAddShapePlusIcon('Characteristic1'))
        .then(() => cyHelp.hasAddShapeOverlay('Characteristic1'))
        .then(() => cy.clickAddShapePlusIcon('Characteristic1'))
        .then(() => cyHelp.hasAddShapeOverlay('Characteristic1'))
  ...
  it('should create NewEntity', () => {
    cy.visitDefault();
    cy.startModelling()
      .then(() => cy.intercept('POST', 'http://localhost:9091/bame/api/models/validate', {fixture: 'response-default-model-validation'}))
      .then(() => cy.dbClickShape('Characteristic1'))
      .then(() => cy.get('button[data-cy="clear-dataType-button"]').click({force: true}))
      .then(() => cy.get(FIELD_dataType).clear().type('NewEntity').get('.mat-option-text').contains('NewEntity').click({force: true}))
      .then(() => cy.get(SELECTOR_editorSaveButton).focus().click({force: true}))
  ...
  it('should create nested enumerations', () => {
    ...
    cy.startModelling()
      ...
      .wait(1000)
      .then(() => cy.shapeExists('Characteristic3'))
      ...
      .then(() =>
        cy
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).eq(0).should('be.visible').type('ev2'))
          .then(() => cy.get(FIELD_propertyValueNotComplex).should('be.visible').type('TestPropertyValue2'))
          .then(() => cy.get(SELECTOR_entitySaveButton).click({force: true}))
          .wait(1000)
          .then(() => cy.get(SELECTOR_editorSaveButton).focus().click({force: true}))
      ...
      .then(() =>
        cy
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').type('ev3'))
          .then(() =>
            cy
              .get(FIELD_propertyValueComplex)
              .eq(0)
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').click({force: true}).type('ev4'))
          .then(() =>
            cy
              .get(FIELD_propertyValueComplex)
              .eq(0)
      ...
      .then(() =>
        cy
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').type('ev5'))
          .then(() =>
            cy
              .get(FIELD_propertyValueComplex)
              .eq(0)
          ...
          .then(() => cy.get(SELECTOR_addEntityValue).click({force: true}))
          .wait(1000)
          .then(() => cy.get(FIELD_entityValueName).should('be.visible').click({force: true}).type('ev6'))
          .then(() =>
            cy
              .get(FIELD_propertyValueComplex)
              .eq(0)
  ...
  /* TODO:This should be removed and use dbClickShape after we solve the problem of 'double click is not triggered' in dbClickShape */
  const dbClickEntityValue = (name: string) => {
    cy.window().then(win => {
      ...
      return cy
        ...
        .then($newShape => {
          ...
          return cy.get(SELECTOR_editorSaveButton).then($button => ($button.is(':visible') ? foundShape : undefined));
        });
    });
  };
});
